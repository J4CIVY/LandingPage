...
export const emailConfigSchema = z.object({
  fromAddress: z.string().email('Email de remitente inválido'),
  toAddress: z.string().email('Email de destinatario inválido'),
  ccAddress: z.string().email('Email CC inválido').optional(),
  bccAddress: z.string().email('Email BCC inválido').optional(),
...
export const notificationEmailSchema = z.object({
  ...
  recipientEmail: z.string().email('Email de destinatario inválido'),
