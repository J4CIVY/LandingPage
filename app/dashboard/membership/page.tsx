...
export default function MembershipPage() {
  ...
  const fetchMembershipData = async () => {
    try {
      ...
      const data = await apiClient.get('/memberships/me') as MembershipResponse;
  ...
  const handleRenewal = async () => {
    ...
    try {
      const apiClient = (await import('@/lib/api-client')).default;
      await apiClient.post('/memberships/renew', {});
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <VolunteerToggle 
              ...
              userData={{
                ...
                email: user?.email || '',
                membershipNumber: (user?.membershipNumber as string | undefined) || '',
