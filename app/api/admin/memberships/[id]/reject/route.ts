...
/**
 * PATCH /api/admin/memberships/[id]/reject
 * Rechaza una solicitud de membresía
 */
async function handlePatch(
  ...
  try {
    ...
    if (application.status === 'rejected') {
      return createErrorResponse('La solicitud ya ha sido rechazada', HTTP_STATUS.BAD_REQUEST);
    }
    ...
    return createErrorResponse('Error al rechazar la solicitud de membresía', HTTP_STATUS.INTERNAL_SERVER_ERROR);
  }
}
