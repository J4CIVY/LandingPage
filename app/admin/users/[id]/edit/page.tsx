...
export default function EditUserPage() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const data = await apiClient.get(`/admin/users/${params.id}`) as { user?: typeof formData };
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const apiClient = (await import('@/lib/api-client')).default;
      await apiClient.put(`/admin/users/${params.id}`, formData as unknown as Record<string, unknown>);
