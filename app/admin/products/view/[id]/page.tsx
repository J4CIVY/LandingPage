...
export default function ProductViewPage() {
  ...
  useEffect(() => {
    const loadProduct = async () => {
      ...
      try {
        ...
        const data = await apiClient.get(`/admin/products/${productId}`) as { product?: typeof product };
  ...
  const handleToggleStatus = async () => {
    ...
    try {
      setToggling(true);
      const apiClient = (await import('@/lib/api-client')).default;
      const data = await apiClient.patch(`/admin/products/${product._id}/toggle-status`) as { product?: { availability: 'in-stock' | 'out-of-stock' } };
