...
export default function ProductFormPage() {
  ...
  useEffect(() => {
    const loadProduct = async () => {
      ...
      try {
        ...
        const data = await apiClient.get(`/admin/products/${productId}`) as { product?: typeof formData };
        if (data.product) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      alert(err.message || 'Error al guardar el producto. Por favor intenta de nuevo.');
    } finally {
      setSaving(false);
    }
  };
