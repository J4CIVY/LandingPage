...
export default function PaymentResultPage() {
  ...
  const fetchTransactionStatus = async () => {
    try {
      ...
      const data = await apiClient.get(`/webhooks/bold/transactions/${orderId}/status`) as { transaction?: TransactionResult };
      ...
      setError(err.message || 'No se pudo obtener el estado de la transacción');
    } finally {
      setLoading(false);
    }
  };
