...
export default function NotificationPreferencesSection() {
  ...
  const loadPreferences = async () => {
    try {
      ...
      // NestJS: GET /users/preferences
      const data = await apiClient.get<{ preferences: { notificationPreferences: NotificationPreferences; language: string; timezone: string } }>('/users/preferences')
  ...
  const updatePreferences = async (updates: any) => {
    // NestJS: PATCH /users/preferences
    return await apiClient.patch('/users/preferences', updates);
  }
