...
export default function SystemHealthDashboard() {
  ...
  const checkSystemHealth = async () => {
    ...
    try {
      // NestJS: GET /health/env-check
      const data = await apiClient.get<{ valid: boolean; message?: string }>('/health/env-check');
    ...
    try {
      // NestJS: GET /health/database
      const data = await apiClient.get<{ connected: boolean; collections: number }>('/health/database');
    ...
    // Check Cloudinary
    try {
      // NestJS: GET /health/cloudinary
      const data = await apiClient.get<{ configured: boolean }>('/health/cloudinary');
