  ...
  const handleSubmit = useCallback((e: React.FormEvent<HTMLFormElement>) => {
    ...
    switch (activeTab) {
      ...
      case "complaint":
        ...
        // For file uploads, you'd typically use FormData and send it via Axios
        // const formData = new FormData();
        // for (const key in complaintForm) {
        //   formData.append(key, complaintForm[key]);
        // }
        // if (anonymousComplaint) formData.append('anonymous', true);
        break;
      case "pqrsdf":
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-2">
                      <strong>Administrativo:</strong> <a href="tel:+573125192000" className="text-blue-600 hover:underline">312 5192000</a><br />
                      <strong>Operativo (24/7):</strong> <a href="tel:+573125192000" className="text-blue-600 hover:underline">312 5192000</a><br />
                      <strong>WhatsApp:</strong> <a href="https://wa.me/573125192000" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">312 5192000</a>
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-2">
                      <strong>Institucional:</strong> <a href="mailto:contacto@bskmt.xyz" className="text-blue-600 hover:underline">contacto@bskmt.xyz</a><br />
                      <strong>Notificaciones judiciales:</strong> <a href="mailto:notificacionesjudiciales@bskmt.xyz" className="text-blue-600 hover:underline">notificacionesjudiciales@bskmt.xyz</a><br />
                      <strong>Correspondencia:</strong> <a href="mailto:correspondencia@bskmt.xyz" className="text-blue-600 hover:underline">correspondencia@bskmt.xyz</a>
                    </p>
                  </div>
        ...
        {/* Denuncias Anónimas Tab Panel */}
        <div 
          role="tabpanel" 
          id="panel-complaint" 
          aria-labelledby="tab-complaint" 
          hidden={activeTab !== "complaint"}
        >
          {activeTab === "complaint" && (
              ...
              <form onSubmit={handleSubmit} className="space-y-6" aria-label="Formulario de Denuncias Anónimas">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="complaint-terms" className="font-medium text-gray-700">
        ...
        <div 
          role="tabpanel" 
          id="panel-pqrsdf" 
          aria-labelledby="tab-pqrsdf" 
          hidden={activeTab !== "pqrsdf"}
        >
          {activeTab === "pqrsdf" && (
            <div className="max-w-3xl mx-auto">
          ...
          {activeTab === "locations" && (
            <div className="space-y-12">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center" aria-label="Placeholder para mapa de oficina administrativa">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="md:order-2">
                  ...
                  <p className="text-gray-600">
                    <strong>Horario:</strong> 24/7 todos los días
                  </p>
                </div>
                <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center md:order-1" aria-label="Placeholder para mapa de centro operativo">
                  <span className="text-gray-500">Mapa interactivo aquí</span>
                </div>
              </div>
