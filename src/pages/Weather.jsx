      ...
      <section className="py-8 px-4 max-w-7xl mx-auto">
        <div className={`grid ${isMobile ? 'grid-cols-1' : 'grid-cols-2'} gap-6`}>
          ...
          <div className="bg-gray-50 rounded-xl shadow-md overflow-hidden">
            <div className="bg-[#000031] text-white p-4">
        ...
        <div className="mt-12 bg-[#f0f9ff] border border-[#00ff99] rounded-xl p-6">
          <h3 className="text-2xl font-bold text-[#000031] mb-4 flex items-center">
