          ...
          <table className="min-w-full bg-white border border-gray-200">
            ...
            <tbody>
              <tr>
                ...
                <td className="py-2 px-4 border">BSK Motorcycle Team</td>
                <td className="py-2 px-4 border">Mantener la sesión del usuario</td>
                <td className="py-2 px-4 border">Sesión</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-2 px-4 border">cookie_consent</td>
                <td className="py-2 px-4 border">BSK Motorcycle Team</td>
                <td className="py-2 px-4 border">Recordar preferencias de cookies</td>
                <td className="py-2 px-4 border">12 meses</td>
              </tr>
              <tr>
                <td className="py-2 px-4 border">_ga</td>
                <td className="py-2 px-4 border">Google Analytics</td>
                <td className="py-2 px-4 border">Distinguir usuarios</td>
                <td className="py-2 px-4 border">24 meses</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-2 px-4 border">_gid</td>
                <td className="py-2 px-4 border">Google Analytics</td>
                <td className="py-2 px-4 border">Distinguir usuarios</td>
                <td className="py-2 px-4 border">24 horas</td>
              </tr>
            </tbody>
          </table>
        </div>
