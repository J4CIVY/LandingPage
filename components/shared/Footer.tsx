        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            ...
            <div className="flex flex-col items-center space-y-2">
              <h5 className="text-sm font-semibold uppercase tracking-wider text-slate-950 dark:text-white">Con El Apoyo De</h5>
            ...
            <div className="flex flex-col items-center space-y-2">
              <h5 className="text-sm font-semibold uppercase tracking-wider text-slate-950 dark:text-white">Vigilado Por</h5>
