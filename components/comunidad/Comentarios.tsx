...
export default function Comentarios({
  ...
  const enviarComentario = async (e: FormEvent) => {
    ...
    try {
      // NestJS: POST /community/comments
      await apiClient.post('/community/comments', {
      ...
      const comentariosData = await apiClient.get<{ datos: Comentario[] }>(`/community/posts/${publicacionId}/comments`);
