  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Historial de Membresía</h2>
          <p className="text-gray-600">Información sobre tu membresía en BSK Motorcycle Team</p>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 text-white mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            ...
            <div className="text-blue-100 text-sm">Años como miembro</div>
          </div>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <div className="text-sm text-blue-100">Miembro desde</div>
            <div className="font-semibold">{formatDate(membresia.fechaAfiliacion)}</div>
          </div>
          <div>
            <div className="text-sm text-blue-100">Vence el</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-green-600">{membresia.renovaciones.length}</div>
              <div className="text-sm text-green-700">Renovaciones</div>
            </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-blue-600">{formatCurrency(totalInvertido)}</div>
              <div className="text-sm text-blue-700">Total invertido</div>
            </div>
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-purple-600">{membresia.beneficiosActivos.length}</div>
              <div className="text-sm text-purple-700">Beneficios activos</div>
            </div>
      ...
      {/* Beneficios activos */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">Beneficios Activos</h3>
        ...
        <div className="space-y-3">
          {(showRenovaciones ? membresia.renovaciones : membresia.renovaciones.slice(0, 2)).map((renovacion, index) => (
            <div key={index} className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${getTipoColor(renovacion.tipo)}`}>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{formatDate(renovacion.fecha)}</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="font-semibold text-gray-900">{formatCurrency(renovacion.monto)}</div>
