...
const BenefitsSection: React.FC = () => (
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Beneficios Sociales */}
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg text-gray-700 dark:text-gray-300">
          <div className="flex items-center mb-4">
            <div className="bg-slate-950 dark:bg-slate-800 text-white dark:text-white p-3 rounded-full mr-4">
