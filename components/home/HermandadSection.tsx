  ...
  return (
    <section className="py-20 px-4 bg-slate-950 dark:bg-slate-white text-white dark:text-slate-950">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          <span className="text-green-400">39 Miembros</span>, <span className="text-green-400">Miles de Kilómetros</span>, <span className="text-red-600">Una Sola Pasión</span>
        </AnimatedHeading>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <AnimatedParagraph
            ...
            delay={800}
            className="text-2xl md:text-3xl italic font-light leading-relaxed"
          >
