    ...
    <section className="py-20 px-4 bg-white dark:bg-slate-950">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <p className="text-2xl md:text-2xl italic font-light text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <p className="mt-6 text-green-400 dark:text-green-400 font-semibold">
            - La Comunidad BSK
          </p>
        </div>
      </div>
