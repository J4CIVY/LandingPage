        ...
        <div className="flex items-center gap-2">
          {localIsEditing && (
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-medium"
            >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="flex items-center gap-2 mt-6">
              <button
                ...
                className="flex-1 px-4 py-2 bg-slate-500 hover:bg-slate-600 disabled:bg-slate-400 text-white rounded-lg font-medium"
              >
                Cancelar
              </button>
              {isUploading && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredDocuments.map((document) => {
            ...
            return (
              <div
                key={document.id}
                className={`p-4 border-2 rounded-lg ${categoryStyle.border} ${categoryStyle.bg} hover:shadow-md`}
              >
                {/* Document Header */}
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-600 rounded-lg text-sm font-medium"
                  >
