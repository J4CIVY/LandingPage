...
export default function AdminPanel() {
  ...
  const cargarDatos = async () => {
    try {
      ...
      // NestJS: GET /admin/gamification/stats
      const statsResult = await apiClient.get<EstadisticasGamificacionAdmin>('/admin/gamification/stats');
      setEstadisticas(statsResult);

      // NestJS: GET /community/rewards
      const recompensasResult = await apiClient.get<any[]>('/community/rewards');
  ...
  const handleCrearRecompensa = async (e: FormEvent) => {
    ...
    try {
      // NestJS: POST /community/rewards
      await apiClient.post('/community/rewards', nuevaRecompensa);
