export const colombianMunicipalities = [
  ...
  "Filadelfia", "La Merced", "Marmato", "Riosucio", "Supía", "Manzanares", "Marquetalia", "Marulanda", "Pensilvania", "Anserma", "Belalcázar", "Risaralda", "San José", "Viterbo", "Chinchina", "Manizales", "Neira", "Palestina", "Villamaria", "Aguadas", "Aranzazu", "Pácora", "Salamina", "La Dorada", "Norcasia", "Samaná", "Victoria",
  "Albania", "Belén De Los Andaquies", "Cartagena Del Chairá", "Currillo", "El Doncello", "El Paujil", "Florencia", "La Montañita", "Milan", "Morelia", "Puerto Rico", "San Jose Del Fragua", "San Vicente Del Caguán", "Solano", "Solita", "Valparaiso",
  "Aguazul", "Chameza", "Hato Corozal", "La Salina", "Maní", "Monterrey", "Nunchía", "Orocué", "Paz De Ariporo", "Pore", "Recetor", "Sabanalarga", "Sácama", "San Luis De Palenque", "Támara", "Tauramena", "Trinidad", "Villanueva", "Yopal",
  "Cajibío", "El Tambo", "La Sierra", "Morales", "Piendamo", "Popayán", "Rosas", "Sotara", "Timbio", "Buenos Aires", "Caloto", "Corinto", "Miranda", "Padilla", "Puerto Tejada", "Santander De Quilichao", "Suarez", "Villa Rica", "Guapi", "Lopez", "Timbiqui", "Caldono", "Inzá", "Jambalo", "Paez", "Purace", "Silvia", "Toribio", "Totoro", "Almaguer", "Argelia", "Balboa", "Bolívar", "Florencia", "La Vega", "Mercaderes", "Patia", "Piamonte", "San Sebastian", "Santa Rosa", "Sucre",
  "Becerril", "Chimichagua", "Chiriguana", "Curumaní", "La Jagua De Ibirico", "Pailitas", "Tamalameque", "Astrea", "Bosconia", "El Copey", "El Paso", "Agustín Codazzi", "La Paz", "Manaure", "Pueblo Bello", "San Diego", "Valledupar", "Aguachica", "Gamarra", "González", "La Gloria", "Pelaya", "Río De Oro", "San Alberto", "San Martín",
  "Atrato", "Bagadó", "Bojaya", "El Carmen De Atrato", "Lloró", "Medio Atrato", "Quibdó", "Rio Quito", "Acandí", "Belén De Bajira", "Carmén Del Darién", "Riosucio", "Unguía", "Bahía Solano", "Juradó", "Nuquí", "Alto Baudó", "Bajo Baudó", "El Litoral Del San Juan", "Medio Baudó", "Canton De San Pablo", "Certegui", "Condoto", "Itsmina", "Medio San Juan", "Nóvita", "Río Frío", "San José Del Palmar", "Sipí", "Tadó", "Union Panamericana",
  "Tierralta", "Valencia", "Chimá", "Cotorra", "Lorica", "Momil", "Purísima", "Montería", "Canalete", "Los Córdobas", "Moñitos", "Puerto Escondido", "San Antero", "San Bernardo Del Viento", "Chinú", "Sahagún", "San Andrés Sotavento", "Ayapel", "Buenavista", "La Apartada", "Montelíbano", "Planeta Rica", "Pueblo Nuevo", "Puerto Libertador", "Cereté", "Ciénaga De Oro", "San Carlos", "San Pelayo",
  ...
  "Barranco Mina", "Cacahual", "Inírida", "La Guadalupe", "Mapiripan", "Morichal", "Pana Pana", "Puerto Colombia", "San Felipe",
  "Calamar", "El Retorno", "Miraflores", "San José Del Guaviare",
  "Agrado", "Altamira", "Garzón", "Gigante", "Guadalupe", "Pital", "Suaza", "Tarqui", "Aipe", "Algeciras", "Baraya", "Campoalegre", "Colombia", "Hobo", "Iquira", "Neiva", "Palermo", "Rivera", "Santa María", "Tello", "Teruel", "Villavieja", "Yaguará", "La Argentina", "La Plata", "Nátaga", "Paicol", "Tesalia", "Acevedo", "Elías", "Isnos", "Oporapa", "Palestina", "Pitalito", "Saladoblanco", "San Agustín", "Timaná",
  "Albania", "Dibulla", "Maicao", "Manaure", "Riohacha", "Uribia", "Barrancas", "Distraccion", "El Molino", "Fonseca", "Hatonuevo", "La Jagua Del Pilar", "San Juan Del Cesar", "Urumita", "Villanueva",
  ...
  "El Castillo", "El Dorado", "Fuente De Oro", "Granada", "La Macarena", "La Uribe", "Lejanías", "Mapiripan", "Mesetas", "Puerto Concordia", "Puerto Lleras", "Puerto Rico", "San Juan De Arama", "Vista Hermosa", "Villavicencio", "Acacias", "Barranca De Upia", "Castilla La Nueva", "Cumaral", "El Calvario", "Guamal", "Restrepo", "San Carlos Guaroa", "San Juanito", "San Luis De Cubarral", "San Martín", "Cabuyaro", "Puerto Gaitán", "Puerto Lopez",
  "Chachagui", "Consaca", "El Peñol", "El Tambo", "La Florida", "Nariño", "Pasto", "Sandoná", "Tangua", "Yacuanquer", "Ancuya", "Guaitarilla", "La Llanada", "Linares", "Los Andes", "Mallama", "Ospina", "Providencia", "Ricaurte", "Samaniego", "Santa Cruz", "Sapuyes", "Tuquerres", "Barbacoas", "El Charco", "Francisco Pizarro", "La Tola", "Magui", "Mosquera", "Olaya Herrera", "Roberto Payan", "Santa Barbara", "Tumaco", "Alban", "Arboleda", "Belen", "Buesaco", "Colon", "Cumbitara", "El Rosario", "El Tablon De Gomez", "La Cruz", "La Union", "Leiva", "Policarpa", "San Bernardo", "San Lorenzo", "San Pablo", "San Pedro De Cartago", "Taminango", "Aldana", "Contadero", "Córdoba", "Cuaspud", "Cumbal", "Funes", "Guachucal", "Gualmatan", "Iles", "Imues", "Ipiales", "Potosí", "Puerres", "Pupiales",
  "Arboledas", "Cucutilla", "Gramalote", "Lourdes", "Salazar", "Santiago", "Villa Caro", "Bucarasica", "El Tarra", "Sardinata", "Tibú", "Abrego", "Cachirá", "Convención", "El Carmen", "Hacarí", "La Esperanza", "La Playa", "Ocaña", "San Calixto", "Teorama", "Cúcuta", "El Zulia", "Los Patios", "Puerto Santander", "San Cayetano", "Villa Del Rosario", "Cácota", "Chitagá", "Mutiscua", "Pamplona", "Pamplonita", "Silos", "Bochalema", "Chinácota", "Durania", "Herrán", "Labateca", "Ragonvalia", "Toledo",
  "Colón", "Mocoa", "Orito", "Puerto Asis", "Puerto Caicedo", "Puerto Guzman", "Puerto Leguizamo", "San Francisco", "San Miguel", "Santiago", "Sibundoy", "Valle Del Guamuez", "Villa Garzon",
  "Armenia", "Buenavista", "Calarca", "Cordoba", "Genova", "Pijao", "Filandia", "Salento", "Circasia", "La Tebaida", "Montengro", "Quimbaya",
  "Dosquebradas", "La Virginia", "Marsella", "Pereira", "Santa Rosa De Cabal", "Apía", "Balboa", "Belén De Umbría", "Guática", "La Celia", "Quinchia", "Santuario", "Mistrató", "Pueblo Rico",
  ...
  "Guaranda", "Majagual", "Sucre", "Chalán", "Coloso", "Morroa", "Ovejas", "Sincelejo", "Coveñas", "Palmito", "San Onofre", "Santiago De Tolú", "Tolú Viejo", "Buenavista", "Corozal", "El Roble", "Galeras", "Los Palmitos", "Sampués", "San Juan Betulia", "San Pedro", "Sincé", "Caimito", "La Unión", "San Benito Abad", "San Marcos",
  ...
  "Andalucía", "Buga", "Bugalagrande", "Calima", "El Cerrito", "Ginebra", "Guacarí", "Restrepo", "Riofrio", "San Pedro", "Trujillo", "Tuluá", "Yotoco", "Alcala", "Ansermanuevo", "Argelia", "Bolívar", "Cartago", "El Águila", "El Cairo", "El Dovio", "La Unión", "La Victoria", "Obando", "Roldanillo", "Toro", "Ulloa", "Versalles", "Zarzal", "Buenaventura", "Caicedonia", "Sevilla", "Cali", "Candelaria", "Dagua", "Florida", "Jamundí", "La Cumbre", "Palmira", "Pradera", "Vijes", "Yumbo",
  "Caruru", "Mitú", "Pacoa", "Papunahua", "Taraira", "Yavaraté",
