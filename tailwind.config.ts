    ...
    extend: {
      colors: {
        primary: {
          ...
          dark: '#020617', // dark mode background
        },
        accent: {
        ...
        bsk: {
          primary: '#22c55e', // BSK Green
          secondary: '#000000', // BSK Black
          accent: '#ffffff', // BSK White
          gray: {
            100: '#f8fafc',
            200: '#e2e8f0',
            300: '#cbd5e1',
  ...
  plugins: [
    ...
    function({ addUtilities }: any) { // eslint-disable-line @typescript-eslint/no-explicit-any
      const newUtilities = {
        ...
        // Utilidades de GPU acceleration
        '.gpu-accelerated': {
          transform: 'translateZ(0)',
          backfaceVisibility: 'hidden',
          perspective: '1000px',
        },
        // Utilidades para mejor UX en touch devices
        '.touch-manipulation': {
